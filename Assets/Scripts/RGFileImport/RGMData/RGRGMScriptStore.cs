...
{
    // attribute nice names, not in an enum because that makes things messy
    public const int active                    =0;
    public const int collide                   =1;
    public const int strength                  =2;
    public const int health                    =3;
    public const int armor                     =4;
    public const int movement                  =5;
    public const int weight                    =6;
    public const int ymove                     =7;
    public const int userflag                  =7; // duplicate id
    public const int forward_speed             =8;
    public const int backward_speed            =9;
    public const int side_speed                =10;
    public const int step_type                 =11;
    public const int forward_walk              =12;
    public const int backward_walk             =13;
    public const int combat                    =14;
    public const int turn_speed                =15;
    public const int fight_lunge_speed         =16;
    public const int fight_forward_speed       =17;
    public const int fight_backward_speed      =18;
    public const int fight_forward_walk        =19;
    public const int fight_backward_walk       =20;
    public const int fight_turn_speed          =21;
    public const int fight_turn_accel          =22;
    public const int weapon                    =23;
    public const int player_align              =24;
    public const int master                    =25;
    public const int slave                     =26;
    public const int slave_type                =27;
    public const int rotation                  =28;
    public const int group                     =29;
    public const int user                      =30;
    public const int jump_time                 =31;
    public const int jump_height               =32;
    public const int no_slave_rot              =33;
    public const int sheath_frame              =34;
    public const int draw_frame                =35;
    public const int ignore_own_matrix         =36;
    public const int stop_y_rotate             =37;
    public const int stop_x_rotate             =38;
    public const int stop_z_rotate             =39;
    public const int stop_x_move               =40;
    public const int stop_y_move               =41;
    public const int stop_z_move               =42;
    public const int always_sync               =43;
    public const int panic_group               =44;
    public const int camera_move               =45;
    public const int camera_pan_type           =46;
    public const int camera_target_offset_x    =47;
    public const int camera_target_offset_y    =48;
    public const int camera_target_offset_z    =49;
    public const int camera_offset_x           =50;
    public const int camera_offset_y           =51;
    public const int camera_offset_z           =52;
    public const int camera_distance           =53;
    public const int dialog_y                  =54;
    public const int no_collide                =55;
    public const int no_sphere_object          =56;
    public const int mass                      =57;
    public const int aggression                =58;
    public const int combat_defense            =59;
    public const int attack                    =60;
    public const int defend                    =61;
    public const int attack_skill              =62;
    public const int defense_skill             =63;
    public const int combat_allies             =64;
    public const int combat_alignment          =65;
    public const int combat_group              =66;
    public const int weapon_type               =67;
    public const int armor_type                =68;
    public const int death_type                =69;
    public const int attack_single             =70;
    public const int attack_double             =71;
    public const int attack_triple             =72;
    public const int attack_thrust             =73;
    public const int attack_lunge              =74;
    public const int attack_low                =75;
    public const int attack_jump_up            =76;
    public const int attack_jump_forward       =77;
    public const int attack_disarm             =78;
    public const int defend_low                =79;
    public const int defend_right              =80;
    public const int defend_left               =81;
    public const int defend_high               =82;
    public const int fight_circle_speed        =83;
    public const int fight_circle_delta_angle  =84;
    public const int num_taunts                =85;
    public const int hit_sound                 =86;
    public const int chatty                    =87;
    public const int twitch                    =88;
    public const int stick_to_surface          =89;
    public const int node_idle                 =90;
    public const int node_climbs               =91;
    public const int node_jumps                =92;
    public const int node_run                  =93;
    public const int node_in_use               =94;
    public const int node_ignore_in_sight      =95;
    public const int damage                    =96;
    public const int npc                       =97;
    public const int bounce_power              =98;
    public const int bounce_move               =99;
    public const int bounce_turn               =100;
    public const int boat_rock_align           =101;
    public const int v_weapon                  =102;
    public const int light_frame               =103;
    public const int unlight_frame             =104;
    public const int player_type               =105;
    public const int special_activate          =106;
    public const int fall_hold                 =107;
    public const int fall_damage               =108;
    public const int zap_anim                  =109;
    public const int holding_weapon            =110;
    public const int reload_type               =111;
    public const int no_continue               =112;
    public const int short_mapping             =113;
    public const int no_view_manage            =114;
    public const int reserved_weight           =115;
    public const int no_node_combat            =116;
    public const int lock_pos                  =117;
    public const int woman                     =118;
    public const int reserved_collide          =119;
    public const int invulnerable              =120;
    public const int combat_ignore_in_sight    =121;
    public const int non_moving                =122;
    public const int combat_long_sight         =123;
    public const int combat_radius_weapon      =124;
    public const int mess_group                =125;
    public const int combat_radius_vhit        =126;
}
