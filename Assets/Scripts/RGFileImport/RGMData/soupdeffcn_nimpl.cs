...
// attribute numbers for reference:
/*
     0 attr_active
     1	attr_collide
     2	attr_strength
     ...
     6	attr_weight
     7	attr_ymove 
attr_user_flag = attr_ymove < weird one, doesnt have a dedicated number i think?
     8	attr_forward_speed
     9	attr_backward_speed
    10	attr_side_speed
    11	attr_step_type
    12	attr_forward_walk
    13	attr_backward_walk
    14	attr_combat
    15	attr_turn_speed
    16	attr_fight_lunge_speed
    17	attr_fight_forward_speed
    18	attr_fight_backward_speed
    19	attr_fight_forward_walk
    20	attr_fight_backward_walk
    21	attr_fight_turn_speed
    22	attr_fight_turn_accel
    23	attr_weapon
    24	attr_player_align
    25	attr_master
    26	attr_slave
    27	attr_slave_type
    28	attr_rotation
    ...
    31	attr_jump_time
    32	attr_jump_height
    33	attr_no_slave_rot
    34	attr_sheath_frame
    35	attr_draw_frame
    36	attr_ignore_own_matrix
    37	attr_stop_y_rotate
    38	attr_stop_x_rotate
    39	attr_stop_z_rotate
    40	attr_stop_x_move
    41	attr_stop_y_move
    42	attr_stop_z_move
    43	attr_always_sync
    44	attr_panic_group
    45	attr_camera_move
    46	attr_camera_pan_type
    47	attr_camera_target_offset_x
    48	attr_camera_target_offset_y
    49	attr_camera_target_offset_z
    50	attr_camera_offset_x
    51	attr_camera_offset_y
    52	attr_camera_offset_z
    53	attr_camera_distance
    54	attr_dialog_y
    55	attr_no_collide
    56	attr_no_sphere_object
    57	attr_mass
    58	attr_aggression
    59	attr_combat_defense
    60	attr_attack
    61	attr_defend
    62	attr_attack_skill
    63	attr_defense_skill
    64	attr_combat_allies
    65	attr_combat_alignment
    66	attr_combat_group
    67	attr_weapon_type
    68	attr_armor_type
    69	attr_death_type
    70	attr_attack_single
    71	attr_attack_double
    72	attr_attack_triple
    73	attr_attack_thrust
    74	attr_attack_lunge
    75	attr_attack_low
    76	attr_attack_jump_up
    77	attr_attack_jump_forward
    78	attr_attack_disarm
    79	attr_defend_low
    80	attr_defend_right
    81	attr_defend_left
    82	attr_defend_high
    83	attr_fight_circle_speed
    84	attr_fight_circle_delta_angle
    85	attr_num_taunts
    86	attr_hit_sound
    87	attr_chatty
    88	attr_twitch
    89	attr_stick_to_surface
    90	attr_node_idle
    91	attr_node_climbs
    92	attr_node_jumps
    93	attr_node_run
    94	attr_node_in_use			; !!! reserved for internal use do not change in script !!!
    95	attr_node_ignore_in_sight
    96	attr_damage
    97	attr_npc
    98	attr_bounce_power
    99	attr_bounce_move
   100	attr_bounce_turn
   101	attr_boat_rock_align
   102	attr_v_weapon
   103	attr_light_frame
   104	attr_unlight_frame
   105	attr_player_type
   106	attr_special_activate
   107	attr_fall_hold
   108	attr_fall_damage
   109	attr_zap_anim
   110	attr_holding_weapon
   111	attr_reload_type
   112	attr_no_continue
   113	attr_short_mapping
   114	attr_no_view_manage
   115	attr_reserved_weight
   116	attr_no_node_combat
   117	attr_lock_pos
   118	attr_woman
   119	attr_reserved_collide
   120	attr_invulnerable
   121	attr_combat_ignore_in_sight
   122	attr_non_moving
   123	attr_combat_long_sight
   124	attr_combat_radius_weapon
   125	attr_mess_group
   126	attr_combat_radius_vhit
*/
